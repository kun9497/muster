...
func TestRenderJoinsItemsWithControlsInIDOrder(t *testing.T) {
	...
	if !strings.Contains(got, "2 of 3 items enrolled; 2 controls (auto 1, partial 0, manual 1)") {
...
func TestRenderMarksDeferredItems(t *testing.T) {
	...
	if !strings.Contains(got, "1 of 4 items enrolled; 1 controls (auto 1, partial 0, manual 0)") {
