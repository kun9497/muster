...
// registry, so --list-actions and the run header name it and a reader can
// see that the collector exists and produced nothing. The --deep flag and
// the warning that the traversal is not implemented yet live in the collect
// command (Task 6); the traversal itself arrives in stage 3.
