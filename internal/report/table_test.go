...
func TestTableScopeLinesAndSeparator(t *testing.T) {
	...
	want := []string{
		...
		"KISA 2026 (6 controls): pass 1 fail 1 warn 0 manual 2 n/a 0 error 1",
		"beyond the guide (0 controls): pass 0 fail 0 warn 0 manual 0 n/a 0 error 0",
		"",
	}
	for i, w := range want {
		if lines[i] != w {
	...
	for _, w := range []string{
		"KISA 2026 (4 controls): pass 1 fail 1 warn 0 manual 1 n/a 0 error 1",
		"beyond the guide (6 controls): pass 1 fail 1 warn 1 manual 1 n/a 1 error 0",
	} {
