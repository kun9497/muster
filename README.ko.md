...
> **상태: 1단계 완료, 2단계 시작 (2026년 9월).** `collect`와 `check`가
> 컨트롤 스무 개(U-01, U-02, U-16, U-19, U-22, U-25, U-29, U-52,
> U-03, U-04, U-05, U-06, U-07, U-08, U-09, U-10, U-11, U-13, U-18, U-55 —
> U-19/U-22/U-29 는 `/etc/hosts`, `/etc/services`, `/etc/hosts.lpd`
> 권한 컨트롤이고, U-03, U-04, U-05, U-06, U-07, U-08, U-09, U-10, U-11, U-13,
> U-18, U-55 는 2단계에서 추가된 계정 계열입니다)로 끝에서 끝까지
> 동작하며, CI가 root·일반 사용자·Ubuntu 22.04/24.04·Rocky/Alma 9
> 컨테이너에서 이를 검증합니다.
> 2단계에서 자동 판정 가능한 KISA 항목 전체를 등재합니다. 아키텍처, 계약, 릴리스
> 범위는 [설계 스펙](docs/superpowers/specs/2026-09-02-muster-design.ko.md)에
> 정리되어 있습니다. 아래에 적힌 것 중 1단계를 넘는 팩트와 플래그는 계획이지
> 약속이 아닙니다.
...
글로벌 벤치마크는 두 번째 규칙집이 아니라 교차 참조입니다. 모든 컨트롤이 지금은
