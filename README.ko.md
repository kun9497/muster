...
> 컨트롤 여덟 개(U-01, U-02, U-16, U-19, U-22, U-25, U-29, U-52 —
> U-19/U-22/U-29 는 새로 추가된 `/etc/hosts`, `/etc/services`,
> `/etc/hosts.lpd` 권한 컨트롤입니다)로 끝에서 끝까지 동작하며, CI가
> root·일반 사용자·Ubuntu 22.04/24.04·Rocky/Alma 9 컨테이너에서 이를 검증합니다.
