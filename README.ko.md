...
> 67개 중 67개 항목이 등재되어 있고, 심층 파일시스템 워크가 필요한 3개(U-15,
...
2. **두 배포판, 자동 판정 가능한 KISA 항목 전체.** Ubuntu와 Rocky 수집기. 67개 중 67개를
   자동 판정하거나 자동 근거를 붙임(auto 57, partial 7, manual 4 — manual은 근거를 함께
